...
<script>
    ...
    import FormCategory from './components/FormCategoryComponent.vue'
    import SidebarCategory from './components/SidebarCategoryComponent.vue'
    import PostDetailsModal from './components/PostDetailsModalComponent.vue';
